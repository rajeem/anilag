...
<table width="66%" border="0" align="center">
  <tr>
    ...
    <td width="49%" bgcolor="#FFFFFF" valign="top"><span class="style1">
	  ...
	  <?php
//author with mname
    if (($author_sname != "") && ($author_fname != "") && ($author_mname != "")) {
        echo $author_sname . ', ' . $author_fname . ' ' . $author_mname{0} . '.<br>';
    }
...
//author w/o mname
    if (($author_sname != "") && ($author_fname != "") && ($author_mname == "")) {
        echo $author_sname . ', ' . $author_fname{0} . '<br>';
    }
...
//title and author w/ mname
    if (($title != "") && ($author_mname != "")) {
        echo '&nbsp;&nbsp;&nbsp;' . $title . ' ' . "/" . ' ' . $author_fname . ' ' . $author_mname{0} . '.' . ' ' . $author_sname;
    }
...
//title and author w/o mname
    if (($title != "") && ($author_mname == "")) {
        echo '&nbsp;&nbsp;&nbsp;' . $title . ' ' . "/" . ' ' . $author_fname . ' ' . $author_sname;
    }
...
//other authors w/ mname
    if (($other_author1_sname != "") && ($other_author1_sname != "") && ($other_author1_sname != "")) {
        echo ' , ' . $other_author1_sname . ' ' . $other_author1_fname . ' ' . $other_author1_mname . '.';
    }
...
//other authors w/o mname
    if (($other_author1_sname != "") && ($other_author1_sname != "") && ($other_author1_sname != "")) {
        echo ' , ' . $other_author1_sname . ' ' . $other_author1_fname . ' ' . $other_author1_mname{0};
    }

    ?>

	    <?php if (($other_author2_sname != "") && ($other_author2_sname != "") && ($other_author2_sname != "")) {
        echo ', ' . $other_author2_sname . ' ' . $other_author2_fname . ' ' . $other_author2_mname{0};
    }
    ?>
        <?php if (($other_author3_sname != "") && ($other_author3_sname != "") && ($other_author3_sname != "")) {
        echo ', ' . $other_author3_sname . ' ' . $other_author3_fname . ' ' . $other_author3_mname{0};
    }
    ?>
        <?php if (($other_author4_sname != "") && ($other_author4_sname != "") && ($other_author4_sname != "")) {
        echo ', ' . $other_author4_sname . ' ' . $other_author4_fname . ' ' . $other_author4_mname{0};
    }
    ?>
        <?php if (($other_author5_sname != "") && ($other_author5_sname != "") && ($other_author5_sname != "")) {
        echo ', ' . $other_author5_sname . ' ' . $other_author5_fname . ' ' . $other_author5_mname{0};
    }
    ?>
        <?php if (($other_author6_sname != "") && ($other_author6_sname != "") && ($other_author6_sname != "")) {
        echo ', ' . $other_author6_sname . ' ' . $other_author6_fname . ' ' . $other_author6_mname{0};
    }
    ?>
        <?php if (($other_author7_sname != "") && ($other_author7_sname != "") && ($other_author7_sname != "")) {
        echo ', ' . $other_author7_sname . ' ' . $other_author7_fname . ' ' . $other_author7_mname{0};
    }
  ...
  <!--<tr>
   ...
   <?php if (($place_pub != "") && ($publisher != "") && ($date_pub != "")) {
        echo '<td bgcolor="#FFFFFF">' . $place_pub . '  ' . $publisher . '  ' . 'c ' . $date_pub . '</td>';
    } else {
...
<table width="66%" border="0" align="center">
  <tr>
    ...
    <td width="49%" bgcolor="#FFFFFF" valign="top"><span class="style1"><?php echo "&nbsp;&nbsp;&nbsp;"; ?>
        <?php if ($title != "") {
    echo $title . "<br>";
} else if ($parallel_title != "") {
    echo $parallel_title . "<br>";
} else if ($oti != "") {
    echo $oti . "<br>";
} else if ($uti != "") {
    echo $uti . "<br>";
    ...
    ?>
        <?php if (($author_sname != "") && ($author_fname != "") && ($author_mname != "")) {
        echo $author_sname . ' ' . $author_fname . ' ' . $author_mname{0} . '<br>';
    }
    ...
    ?>
	    <?php if (($other_author1_sname != "") && ($other_author1_sname != "") && ($other_author1_sname != "")) {
        echo ', ' . $other_author1_sname . ' ' . $other_author1_fname . ' ' . $other_author1_mname{0};
    }
    ?>
    ...
    ?><?php if (($place_pub != "") && ($publisher != "") && ($date_pub != "")) {?><?php echo '&nbsp;--' . ' ' . $place_pub . ':' . ' ' . $publisher . ', ' . 'c' . $date_pub; ?><?php }?>
     </span></td>
  </tr>
 <tr>
    <td align="left" bgcolor="#FFFFFF"><span class="style1"></span></td>
...
<table width="66%" border="0" align="center">
  <tr>
    <td width="10%" align="left" bgcolor="#FFFFFF"><span class="style1"><?php //echo $letter.'<br>'.$access_no.'<br>'.$call_num.'<br>'.$date_year;?>
      <?php echo $classification_no . '<br>' . $book_no . '<br>' . $date_year; ?></span></td>
    <td width="49%" bgcolor="#FFFFFF" valign="top"><span class="style1"><?php if ($title != "") {
    echo $title . "<br>";
} else if ($parallel_title != "") {
    echo $parallel_title . "<br>";
} else if ($oti != "") {
    ...
    ?><?php if (($place_pub != "") && ($publisher != "") && ($date_pub != "")) {?>. -- <?php echo $place_pub; ?>: <?php echo $publisher; ?>, c<?php echo $date_pub; ?><?php }?></span></td>
  </tr>
  <tr>
    <td align="left" bgcolor="#FFFFFF"><span class="style1"></span></td>
      <td align="left" bgcolor="#FFFFFF">
