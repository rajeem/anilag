  ...
  <div class="floatelft">
    ...
    <form id="form1" name="myform" method="post" action="overdue.php">
      <table width="100%" cellpadding="5" cellspacing="5" class="bg">
        ...
        <tr>
          <td valign="top"><strong>Date:</strong>            <select name="search" id="search"><option value="today" <?php  if ($search=="today")echo selected;?>>Today</option><option value="tomorrow" <?php  if ($search=="tomorrow")echo selected;?>>Tomorrow</option>
		  <option value="all" <?php  if ($search=="all")echo selected;?>>All</option></select></td>
...
?>
			<option  <?php  if ($type=="$school_code")echo selected;?>><?php echo $school_code;?></option>
<?php $i++; }?><option value="all" <?php  if ($type=="all")echo selected;?>>All</option>
</select> </td>
          <td>
            <label></label>
