  ...
  <div class="floatelft">
    ...
    <table width="100%" border="0">
      <tr>
        ...
        Search</a></td>
        <td width="11%" align="center"><?php if ($add_book=="on") echo '<a href="admin_add_new.php" title="Add new books."><img src="images/add.jpg" width="72" height="61" /><br />
        Add Book</a>'; else echo '<img src="images/add.jpg" width="72" height="61" /><br />
        Add Book';?></td>
      ...
      <tr>
        <td align="center"><?php if ($uri=="admin")echo '<a href="inventory.php">
        <img src="images/inventory.jpg" width="72" height="64" /><br />
        Inventory</a>'; else echo' <img src="images/inventory.jpg" width="72" height="64" /><br />
        Inventory'; ?></td>
        <td align="center"><?php if ($uri=="admin")echo '<a href="settings.php">
        <img src="images/settings.jpg" width="72" height="61" /><br />
        Settings</a>'; else echo '<img src="images/settings.jpg" width="72" height="61" /><br />
        Settings';?></td>
         <td align="center"><?php if ($uri=="admin")echo '<a href="#" onclick=MM_openBrWindow1("restore_backup.php","","scrollbars=yes,width=500,height=370")>
        <img src="images/thumb.png" width="72" height="61" /><br/>
        Backup/Restore</a>'; else echo '<img src="images/thumb.png" width="72" height="61" /><br/>
        Backup/Restore';?> </td>
        <td>&nbsp;</td>
