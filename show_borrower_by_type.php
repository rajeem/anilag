...
$sql = "SELECT *,concat(first1,' ',last1)
	as wholename from barrower where school_code='$type_code' order by bar_id";
...
if ($page > 1) {
    ...
    $pagination .= '<a href="show_borrower_by_type.php?page=' . $prev . '"
...
for ($i = 1; $i <= $total_pages; $i++) {
    if (($page) == $i) {
        ...
        $pagination .= '&nbsp;<a href="show_borrower_by_type.php?page=' . $i . '" title="page ' . $i . '">' . $i . '</a>&nbsp;';
    }
}

/* Print NEXT link if there is one */
if ($page < $total_pages) {
    $pagination .= '<a href="show_borrower_by_type.php?page=' . $next . '"
	title="Next">Next &gt;</a>';
...
$x = 2;
      ...
      <tr>
        ...
        <a href="show_borrower_by_type.php?id=<?php echo $id; ?>&amp;bar_id=<?php echo $bar_id; ?>"onclick="return trash();">delete</a>        <?php echo '<a href="show_borrower_by_type.php"  onClick="MM_openBrWindow1(\'edit.php?id=' . $id . '\',\'\',\'scrollbars=yes,width=400,height=300\')" style="cursor: pointer;">Edit</a>'; ?></td>
      </tr>
        <?php
      ...
      <tr>
        <td><input type="button" name="submit2" value="Print..." class="btn" onclick="MM_openBrWindow1('report/index.php?sql=5&school=<?php echo $type_code; ?>&from=<?php echo $from; ?>&to=<?php echo $max_results; ?>','','scrollbars=yes,width=1000,height=800')" onmouseover="this.className='btn btnhov'" onmouseout="this.className='btn'"/></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
