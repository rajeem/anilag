...
$pagination = ''; 
	...
	$pagination .= '<a href="show_all_books.php?type='.$type.'&txt='.$txt.'&sql='.$sql.'&search='.$search.'&page='.$prev.'"
	...
	{ 
		...
		$pagination .= '&nbsp;<a href="show_all_books.php?type='.$type.'&txt='.$txt.'&sql='.$sql.'&search='.$search.'&page='.$i.'" title="page '.$i.'">' .$i. '</a>&nbsp;'; 
		} 
	} 
	...
	if($page < $total_pages) 
	{ 
	$pagination .= '<a href="show_all_books.php?type='.$type.'&txt='.$txt.'&sql='.$sql.'&search='.$search.'&page='.$next.'"
	title="Next">Next &gt;</a>'; 
	...
	if($search!=""){
		...
		<?php if($book_preview=="on"){ ?>
		  <tr>
		    ...
		    <td  colspan="2"bgcolor="#000000" align="center"><strong class="style9">Features </strong></td>
 	 ...
 	 ";?>
		...
		<?php if($book_preview=="off"){ ?>
		  <tr>
		  <td width="20%"  colspan="2"bgcolor="#000000" align="center"><strong class="style9">Features </strong></td>
 		   <td width="8%" bgcolor="#000000"><strong class="style9">Download</strong></td>
 		   <td width="19%" bgcolor="#000000"><strong class="style9">Book Title </strong></td>
...
?>
  ...
  <tr>
    ...
    <td bgcolor="<?php echo $bg;?>" colspan="2"><?php echo '<a href="#"  onClick="MM_openBrWindow1(\'plus_info.php?id='.$id.'\',\'\',\'scrollbars=yes,width=600,height=500\')" style="cursor: pointer;">Card Catalog</a>';?> | <a href="admin_edit2.php?id=<?php echo $id;?>">edit</a> | <a href="admin_delete.php?id=<?php echo $id;?>" onclick="return trash();">delete</a></td>
    ...
    <td bgcolor="<?php echo $bg;?>"> <?php if($qty==0){
				  ...
				  echo'<a href="bar_new.php?access_no_from='.$access_no.'">Available</a>';
				  }
